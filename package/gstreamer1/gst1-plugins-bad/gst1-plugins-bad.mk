...
ifeq ($(BR2_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_SRT),y)
GST1_PLUGINS_BAD_CONF_OPTS += -Dsrt=enabled
GST1_PLUGINS_BAD_DEPENDENCIES += libsrt
else
GST1_PLUGINS_BAD_CONF_OPTS += -Dsrt=disabled
endif
